    ...
    def doScan(File root, String type, List<Tarification> newCodes = null, List<String> subset = null) {
        ...
        if (codes.size() == 0) {
            ...
            def groups = [
                    ...
                    Full: ['Accouchements - accoucheuses', 'Bandages, ceintures et protheses des seins', 'Cardiologie', 'Chirurgie abdominale', 'Chirurgie des vaisseaux', 'Chirurgie générale', 'Chirurgie plastique', 'Chirurgie thoracique', 'Dermato-vénéréologie', 'Gastro-entérologie', 'Gynécologie et obstétrique', 'Logopédie', 'Médecine interne', 'Médecine nucléaire in vitro', 'Médecine nucléaire in vivo', 'Neurochirurgie', 'Neuropsychiatrie', 'Ophtalmologie', 'Orthopédie', 'Oto-rhino-laryngologie', 'Pédiatrie', 'Physiothérapie', 'Pneumologie', 'Radio-isotopes', 'Radiodiagnostic', 'Soins dentaires', 'Soins par audiciens', 'Soins par opticiens', 'Stomatologie', 'Urologie']
