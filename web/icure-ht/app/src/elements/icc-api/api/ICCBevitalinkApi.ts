...
export class iccBevitalinkApi {
    ...
    getSumehrsFromVitalink(niss: string, includeBusinessData?: boolean, breakTheGlass?: boolean, reason?: string) : Promise<models.Prescription|any> {
        let _body = null
    ...
    putSumehrOnVitalink(token: string, niss: string, formatCode?: string, reference?: string, previousVersionId?: string, previousVersionNumber?: string, body?: string) : Promise<models.Prescription|any> {
        let _body = null
        _body = body
