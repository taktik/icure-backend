...
export class iccBegeninsApi {
    ...
    getGeneralInsurability(token: string, niss: string, date?: number, hospitalized?: boolean) : Promise<models.InsurabilityInfo|any> {
        let _body = null
    ...
    getGeneralInsurabilityWithRegNumber(token: string, insurance: string, regNumber: string, hospitalized?: boolean, date?: number) : Promise<models.InsurabilityInfo|any> {
        let _body = null
