		...
		<div class="subform-container">
			<template id="subforms-repeat" is="dom-repeat" items="[[subContexts]]" as="subContext">
				<div class="relative">
					...
					<dynamic-form id="sf-[[index]]" api="[[api]]" user="[[user]]" template="[[_getTemplate(subContext)]]" data-map="[[subContext.dataMap]]" data-provider="[[subContext.dataProvider]]" read-only="[[readOnly]]" is-sub-form="" i18n="[[i18n]]" resources="[[resources]]" language="[[language]]"></dynamic-form>
				</div>
			</template>
		</div>
`;
