...
interface ClassificationTemplateLogic : EntityPersister<ClassificationTemplate, String> {
    ...
    suspend fun createClassificationTemplate(@Check classificationTemplate: ClassificationTemplate): ClassificationTemplate?
    ...
    suspend fun modifyClassificationTemplate(@Check classificationTemplate: ClassificationTemplate): ClassificationTemplate
