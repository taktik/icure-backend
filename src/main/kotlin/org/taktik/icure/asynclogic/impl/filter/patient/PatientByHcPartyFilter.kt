...
//
//@Service
//class PatientByHcPartyFilter : Filter<String?, Patient?, PatientByHcPartyFilter?> {
...
//    }
//
//    override fun resolve(filter: PatientByHcPartyFilter, context: Filters): Set<String> {
//        return try {
//            HashSet(patientLogic!!.listByHcPartyIdsOnly(if (filter.healthcarePartyId != null) filter.healthcarePartyId else loggedHealthCarePartyId))
