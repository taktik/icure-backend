...
//
//class PatientByHcPartyAndSsinFilter : Filter<String?, Patient?, PatientByHcPartyAndSsinFilter?> {
...
//    }
//
//    override fun resolve(filter: PatientByHcPartyAndSsinFilter, context: Filters): Set<String> {
//        return try {
//            HashSet(patientLogic!!.listByHcPartyAndSsinIdsOnly(filter.ssin, if (filter.healthcarePartyId != null) filter.healthcarePartyId else loggedHealthCarePartyId))
