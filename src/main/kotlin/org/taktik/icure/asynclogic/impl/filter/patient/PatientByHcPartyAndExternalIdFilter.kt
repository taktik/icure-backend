...
//
//class PatientByHcPartyAndExternalIdFilter : Filter<String?, Patient?, PatientByHcPartyAndExternalIdFilter?> {
...
//    }
//
//    override fun resolve(filter: PatientByHcPartyAndExternalIdFilter, context: Filters): Set<String> {
//        return try {
//            HashSet(patientLogic!!.listByHcPartyAndExternalIdsOnly(filter.externalId, if (filter.healthcarePartyId != null) filter.healthcarePartyId else loggedHealthCarePartyId))
