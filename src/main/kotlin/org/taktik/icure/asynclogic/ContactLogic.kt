...
interface ContactLogic : EntityPersister<Contact, String> {
	...
	fun listServicesForHealthElementIds(hcPartyId: String, healthElementIds: List<String>): Flow<Service>
    fun listServiceIdsForHealthElementIds(hcPartyId: String, healthElementIds: List<String>): Flow<String>
