...
class CouchDbLocalConfig(val couchDbProperties: CouchDbProperties) {
    ...
    @Bean fun couchdbBase(couchdbInstance:CouchDbInstance) = StdCouchDbICureConnector("icure-base-dev-master", couchdbInstance)
    @Bean fun couchdbPatient(couchdbInstance:CouchDbInstance) = StdCouchDbICureConnector("icure-patient-dev-master", couchdbInstance)
    @Bean fun couchdbHealthdata(couchdbInstance:CouchDbInstance) = StdCouchDbICureConnector("icure-healthdata-dev-master", couchdbInstance)
