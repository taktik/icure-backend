 ...
 */
class Measure(var label: String = "", var unit: String = "", var value: Number? = null, val minRef: Number? = null, val maxRef: Number? = null, val severity: Number = 0) : Serializable, Data {
	fun checkValue(): Int {
