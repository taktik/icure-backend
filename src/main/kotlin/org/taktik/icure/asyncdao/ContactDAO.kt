...
interface ContactDAO: GenericDAO<Contact> {
    ...
    fun get(dbInstanceUrl: URI, groupId: String, contactIds: Flow<String>): Flow<Contact>
    ...
    fun getPaginatedContacts(dbInstanceUrl: URI, groupId: String, contactIds: Flow<String>): Flow<ViewQueryResultEvent>
    ...
    fun findByHcPartyFormIds(dbInstanceUrl: URI, groupId: String, hcPartyId: String, ids: List<String>): Flow<Contact>
    ...
    fun listByServices(dbInstanceUrl: URI, groupId: String, services: Collection<String>): Flow<Contact>
