...
class TarificationDAOImpl(@Qualifier("baseCouchDbDispatcher") couchDbDispatcher: CouchDbDispatcher, idGenerator: IDGenerator, mapper: MapperFacade) : GenericDAOImpl<Tarification>(Tarification::class.java, couchDbDispatcher, idGenerator, mapper), TarificationDAO {
