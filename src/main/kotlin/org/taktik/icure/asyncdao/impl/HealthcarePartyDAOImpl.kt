...
internal class HealthcarePartyDAOImpl(@Qualifier("baseCouchDbDispatcher") couchDbDispatcher: CouchDbDispatcher, idGenerator: IDGenerator, @Qualifier("asyncCacheManager") AsyncCacheManager: AsyncCacheManager, mapper: MapperFacade) : CachedDAOImpl<HealthcareParty>(HealthcareParty::class.java, couchDbDispatcher, idGenerator, AsyncCacheManager, mapper), HealthcarePartyDAO {
    ...
    override fun findBySsinOrNihii(dbInstanceUrl: URI, groupId: String, searchValue: String?, offset: PaginationOffset<String>, desc: Boolean?): Flow<ViewQueryResultEvent> {
        val client = couchDbDispatcher.getClient(dbInstanceUrl, groupId)
    ...
    override fun findByHcPartyNameContainsFuzzy(dbInstanceUrl: URI, groupId: String, searchString: String?, offset: PaginationOffset<String>, desc: Boolean?): Flow<ViewQueryResultEvent> {
        val client = couchDbDispatcher.getClient(dbInstanceUrl, groupId)
    ...
    override fun findHealthcareParties(dbInstanceUrl: URI, groupId: String, searchString: String, offset: Int, limit: Int): Flow<HealthcareParty> {
        val client = couchDbDispatcher.getClient(dbInstanceUrl, groupId)
        // TODO test
