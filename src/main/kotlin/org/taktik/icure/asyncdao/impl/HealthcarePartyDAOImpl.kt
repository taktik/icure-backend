...
internal class HealthcarePartyDAOImpl(couchDbProperties: CouchDbProperties,
    ...
    override fun listHealthcareParties(searchString: String, offset: Int, limit: Int): Flow<HealthcareParty> = flow {
        ...
        emitAll(client.queryViewIncludeDocs<String, String, HealthcareParty>(createQuery(client, "by_hcParty_name").startKey(from).endKey(to).includeDocs(true).limit(limit + offset)).map { it.doc }
