    ...
    private suspend fun parseGenericTransaction(trn: TransactionType,
        ...
        return Contact(
                ...
                services = trn.findItems().mapNotNull { item ->
                    ...
                    when (cdItem) {
                        "healthcareelement" -> {
                            val he = parseHealthcareElement(mapping?.cdItem ?: cdItem, label, item, author, language, v, contactId)
                            he?.let { notNullHe ->
                        ...
                        "insurancystatus", "gmdmanager" -> null // not services
                            ...
                            parseGenericItem(mapping?.cdItem ?: cdItem, label, item, author, language, v)?.also {service ->
