...
import org.taktik.icure.be.ehealth.dto.kmehr.v20150901.be.fgov.ehealth.standards.kmehr.cd.v1.CDCOUNTRYschemes.CD_COUNTRY
import org.taktik.icure.be.ehealth.dto.kmehr.v20150901.be.fgov.ehealth.standards.kmehr.cd.v1.CDHCPARTYschemes.CD_HCPARTY
import org.taktik.icure.be.ehealth.dto.kmehr.v20150901.be.fgov.ehealth.standards.kmehr.cd.v1.CDLIFECYCLEvalues.ACTIVE
...
import org.taktik.icure.be.ehealth.dto.kmehr.v20150901.be.fgov.ehealth.standards.kmehr.id.v1.IDHCPARTYschemes.INSS
import org.taktik.icure.be.ehealth.dto.kmehr.v20150901.be.fgov.ehealth.standards.kmehr.id.v1.IDPATIENTschemes.ID_PATIENT
        ...
        return Kmehrmessage().apply {
            header = HeaderType().apply {
                ...
                this.sender = SenderType().apply {
                    ...
                    hcparties.add(HcpartyType().apply { ; this.cds.addAll(listOf(CDHCPARTY().apply { s = CDHCPARTYschemes.CD_HCPARTY; sv = "1.9"; value="application" })); this.name = "iCure ${ICUREVERSION}" })
                }
            }
        }
    }
