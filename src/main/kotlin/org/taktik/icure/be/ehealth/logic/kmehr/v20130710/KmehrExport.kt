...
import org.taktik.icure.be.ehealth.dto.kmehr.v20130710.be.fgov.ehealth.standards.kmehr.cd.v1.CDCOUNTRYschemes.CD_COUNTRY
import org.taktik.icure.be.ehealth.dto.kmehr.v20130710.be.fgov.ehealth.standards.kmehr.cd.v1.CDHCPARTYschemes.CD_HCPARTY
import org.taktik.icure.be.ehealth.dto.kmehr.v20130710.be.fgov.ehealth.standards.kmehr.cd.v1.CDLIFECYCLEvalues.ACTIVE
import org.taktik.icure.be.ehealth.dto.kmehr.v20130710.be.fgov.ehealth.standards.kmehr.dt.v1.TextType
import org.taktik.icure.be.ehealth.dto.kmehr.v20130710.be.fgov.ehealth.standards.kmehr.id.v1.*
import org.taktik.icure.be.ehealth.dto.kmehr.v20130710.be.fgov.ehealth.standards.kmehr.id.v1.IDHCPARTYschemes.*
import org.taktik.icure.be.ehealth.dto.kmehr.v20130710.be.fgov.ehealth.standards.kmehr.id.v1.IDHCPARTYschemes.INSS
import org.taktik.icure.be.ehealth.dto.kmehr.v20130710.be.fgov.ehealth.standards.kmehr.id.v1.IDPATIENTschemes.ID_PATIENT
            ...
            ContentType().apply {
                ...
                content.medicationValue?.medicinalProduct?.let {
                    medicinalproduct = ContentType.Medicinalproduct().apply {
                        ...
                        intendedcd = CDDRUGCNK().apply { s = "CD-DRUG-CNK"; sv = "01-2016"; value = content.medicationValue?.medicinalProduct?.intendedcds?.find { it.type == "CD-DRUG-CNK" }?.code }
                    }
                }
        ...
        return Kmehrmessage().apply {
            header = HeaderType().apply {
                ...
                this.sender = SenderType().apply {
                    ...
                    hcparties.add(HcpartyType().apply { ; this.cds.addAll(listOf(CDHCPARTY().apply { s = CDHCPARTYschemes.CD_HCPARTY; sv = "1.5"; value="application" })); this.name = "iCure ${ICUREVERSION}" })
                }
            }
        }
    }
