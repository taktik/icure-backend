...
class PatientInfoLogicImpl(val patientInfoFileExport: PatientInfoFileExport) : PatientInfoFileLogic {
    override fun createExport(outputStream: OutputStream, patient: Patient, sender: HealthcareParty, language: String) {
        patientInfoFileExport!!.export(outputStream, patient, sender, language)
    }
}
