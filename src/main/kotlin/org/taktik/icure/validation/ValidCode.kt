...
annotation class ValidCode(val message: String = "{org.taktik.icure.validation.ValidCode.message}", val groups: Array<KClass<*>> = [], val payload: Array<KClass<Any>> = [], val autoFix: AutoFix = AutoFix.NOFIX) {
    /**
