...
constructor(@Qualifier("couchdbConfig") couchdb: CouchDbICureConnector, idGenerator: IDGenerator) : GenericDAOImpl<Vmp>(Vmp::class.java, couchdb, idGenerator), VmpDAO {
    init {
