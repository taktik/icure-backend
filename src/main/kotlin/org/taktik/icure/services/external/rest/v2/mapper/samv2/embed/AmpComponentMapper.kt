...
@Mapper(componentModel = "spring", uses = [RouteOfAdministrationV2Mapper::class, PharmaceuticalFormStubV2Mapper::class, SamTextV2Mapper::class, IngredientV2Mapper::class], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
