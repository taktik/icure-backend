...
@Mapper(componentModel = "spring", uses = [MultipleTypeMapper::class, MedicineTypeMapper::class, IngredientTypeMapper::class, QuantityMapper::class, SubstanceStubMapper::class, IngredientTypeMapper::class], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
