...
class GroupController(couchDbProperties: CouchDbProperties,
    ...
    @ApiOperation(nickname = "lisGroups", value = "List groups", notes = "Create a new gorup with associated dbs")
    @GetMapping
    fun listGroups() = groupLogic.listGroups().injectReactorContext()
}
