...
@Mapper(componentModel = "spring", uses = [StrengthRangeMapper::class, SubstanceStubMapper::class, IngredientTypeMapper::class], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
