...
data class PersonNameDto(
        ...
        @Schema(description = "Given names (not always 'first'). Includes middle names. This repeating element order: Given Names appear in the correct order for presenting the name") val firstNames: List<String> = listOf(),
        ...
        @Schema(description = "Parts that come before the name. This repeating element order: Prefixes appear in the correct order for presenting the name") val prefix: List<String> = listOf(),
        @Schema(description = "Parts that come after the name. This repeating element order: Suffixes appear in the correct order for presenting the name") val suffix: List<String> = listOf(),
