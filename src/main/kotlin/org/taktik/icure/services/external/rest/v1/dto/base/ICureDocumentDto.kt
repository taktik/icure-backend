...
interface ICureDocumentDto<T> : IdentifiableDto<T>, HasTagsDto, HasCodesDto {
	@get:Schema(description = "The timestamp (unix epoch in ms) of creation of this entity, will be filled automatically if missing. Not enforced by the application server.")
	val created: Long?
	@get:Schema(description = "The date (unix epoch in ms) of the latest modification of this entity, will be filled automatically if missing. Not enforced by the application server.")
	val modified: Long?
