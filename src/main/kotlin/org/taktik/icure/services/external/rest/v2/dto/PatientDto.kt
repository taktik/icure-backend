...
data class PatientDto(
        ...
        @Schema(description = "the next firstnames of the patient") val additionalFirstNames: List<String> = emptyList(),
        @Schema(description = "the other names corresponding to the patient, using another denomination") val otherNames: List<PersonNameDto> = emptyList(),
        ...
        @Schema(description = "The ids of the patients that have been merged inside this patient.") val mergedIds: Set<String> = HashSet(),
        ...
        @Schema(description = "List of insurance coverages (of class Insurability, see below).") val insurabilities: List<InsurabilityDto> = listOf(),
        @Schema(description = "List of partners, or persons of contact (of class Partnership, see below).") val partnerships: List<PartnershipDto> = listOf(),
        @Schema(description = "Links (usually for therapeutic reasons) between this patient and healthcare parties (of class PatientHealthcareParty).") val patientHealthCareParties: List<PatientHealthCarePartyDto> = listOf(),
        @Schema(description = "Financial information (Bank, bank account) used to reimburse the patient.") val financialInstitutionInformation: List<FinancialInstitutionInformationDto> = listOf(),
        @Schema(description = "Contracts between the patient and the healthcare entity.") val medicalHouseContracts: List<MedicalHouseContractDto> = listOf(),
        @Schema(description = "Codified list of professions exercised by this patient.")  val patientProfessions: List<CodeStubDto> = listOf(),
        @Schema(description = "Extra parameters") val parameters: Map<String, List<String>> = mapOf(),
        @Schema(description = "Extra properties") val properties: Set<PropertyStubDto> = HashSet(),
        ...
        @get:Deprecated("Do not use") val nonDuplicateIds: Set<String> = HashSet(),
        @get:Deprecated("Do not use") val encryptedAdministrativesDocuments: Set<String> = HashSet(),
