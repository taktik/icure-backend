...
data class CapabilityStatementRest(
  val compartment: List<String> = listOf(),
  /**
  ...
  val interaction: List<CapabilityStatementRestInteraction> = listOf(),
  /**
   * client | server
   */
  ...
  val resource: List<CapabilityStatementRestResource> = listOf(),
  val searchParam: List<CapabilityStatementRestResourceSearchParam> = listOf(),
  /**
   * Information about security of implementation
   */
  val security: CapabilityStatementRestSecurity? = null
) : BackboneElement
