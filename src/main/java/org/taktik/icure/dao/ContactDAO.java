...
public interface ContactDAO extends GenericDAO<Contact> {
	...
	List<String> findServicesByPatientCode(String hcPartyId, List<String> patientSecretForeignKeys, String codeType, String codeCode, Long startValueDate, Long endValueDate);
