...
@Service
public class PatientByHcPartyFilter implements Filter<String, Patient, org.taktik.icure.dto.filter.patient.PatientByHcPartyFilter> {
    ...
    @Override
    public Set<String> resolve(org.taktik.icure.dto.filter.patient.PatientByHcPartyFilter filter, Filters context) {
        try {
            return new HashSet<>(patientLogic.listByHcPartyIdsOnly(filter.getHealthcarePartyId() != null ? filter.getHealthcarePartyId() : getLoggedHealthCarePartyId()));
