...
public class PatientByHcPartyNameContainsFuzzyFilter implements Filter<String, Patient, org.taktik.icure.dto.filter.patient.PatientByHcPartyNameContainsFuzzyFilter> {
    ...
    @Override
    public Set<String> resolve(org.taktik.icure.dto.filter.patient.PatientByHcPartyNameContainsFuzzyFilter filter, Filters context) {
        try {
            return new HashSet<>(patientLogic.listByHcPartyNameContainsFuzzyIdsOnly(filter.getSearchString(), filter.getHealthcarePartyId() != null ? filter.getHealthcarePartyId() : getLoggedHealthCarePartyId()));
