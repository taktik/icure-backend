...
@Service
public class PatientByHcPartyDateOfBirthFilter implements Filter<String, Patient, org.taktik.icure.dto.filter.patient.PatientByHcPartyDateOfBirthFilter> {
    ...
    @Override
    public Set<String> resolve(org.taktik.icure.dto.filter.patient.PatientByHcPartyDateOfBirthFilter filter, Filters context) {
        try {
            return new HashSet<>(patientLogic.listByHcPartyDateOfBirthIdsOnly(filter.getDateOfBirth(), filter.getHealthcarePartyId() != null ? filter.getHealthcarePartyId() : getLoggedHealthCarePartyId()));
