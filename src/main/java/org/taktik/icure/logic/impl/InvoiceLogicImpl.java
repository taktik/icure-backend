...
public class InvoiceLogicImpl extends GenericLogicImpl<Invoice, InvoiceDAO> implements InvoiceLogic {
	...
	@Override
	public PaginatedList<Invoice> findByAuthor(String hcPartyId, Long fromDate, Long toDate, PaginationOffset paginationOffset) {
		return invoiceDAO.findByHcParty(hcPartyId, fromDate, toDate, paginationOffset);
	}
