...
public class ContactLogicImpl extends GenericLogicImpl<Contact, ContactDAO> implements ContactLogic {
	...
	public List<String> findServicesByCode(String hcPartyId, List<String> patientSecretForeignKeys, String codeType, String codeCode, Long startValueDate, Long endValueDate) {
		return patientSecretForeignKeys == null ? contactDAO.findServicesByCode(hcPartyId, codeType, codeCode, startValueDate, endValueDate) : contactDAO.findServicesByPatientCode(hcPartyId, patientSecretForeignKeys, codeType, codeCode, startValueDate, endValueDate);
	}
