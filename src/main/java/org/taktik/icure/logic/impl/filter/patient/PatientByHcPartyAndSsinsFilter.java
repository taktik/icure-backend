...
public class PatientByHcPartyAndSsinsFilter implements Filter<String, Patient, org.taktik.icure.dto.filter.patient.PatientByHcPartyAndSsinsFilter> {
    ...
    @Override
    public Set<String> resolve(org.taktik.icure.dto.filter.patient.PatientByHcPartyAndSsinsFilter filter, Filters context) {
        try {
            return new HashSet<>(patientLogic.listByHcPartyAndSsinsIdsOnly(filter.getSsins(), filter.getHealthcarePartyId() != null ? filter.getHealthcarePartyId() : getLoggedHealthCarePartyId()));
