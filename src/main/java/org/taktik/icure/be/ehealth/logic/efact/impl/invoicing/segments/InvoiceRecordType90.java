...
public class InvoiceRecordType90 extends InvoiceRecord {

	private static final Map<String, ZoneDescription> ZONE_DESCRIPTIONS_BY_ZONE = new LinkedHashMap<>();

	private static int position = 1;

	static {
		position = register(ZONE_DESCRIPTIONS_BY_ZONE, "1", "EnregistrementDeType90", "N", position, 2);
		...
		position = register(ZONE_DESCRIPTIONS_BY_ZONE, "4", "Reserve", "N", position, 7);
		...
		position = register(ZONE_DESCRIPTIONS_BY_ZONE, "7", "NumeroDenvoi", "N", position, 3);
		...
		position = register(ZONE_DESCRIPTIONS_BY_ZONE, "15", "SigneMontantTotalNumeroCompteFinancierB", "A", position, 12);
		...
		position = register(ZONE_DESCRIPTIONS_BY_ZONE, "19", "SigneMontantTotalNumeroCompteFinancierA", "A", position, 12);
	...
	public InvoiceRecordType90() {
		append(ZONE_DESCRIPTIONS_BY_ZONE.get("1"), "90");
	}
