...
public class GetSubFormEditionReply implements Serializable {
	...
	public GetSubFormEditionReply(FormContent formContent, List<FormTemplateDto> templates) {
		this.formContent = formContent;
		this.templates = templates;
	}
	
	public GetSubFormEditionReply(){}
