...
/**
 * The Class BeanPropertyValueComparableLessThanPredicate.
 */
public class BeanPropertyValueComparableLessThanPredicate<T> extends AbstractBeanPropertyValuePredicate<T> {
	/**
	 ...
	 */
	public BeanPropertyValueComparableLessThanPredicate(String propertyName, Object propertyValue) {
