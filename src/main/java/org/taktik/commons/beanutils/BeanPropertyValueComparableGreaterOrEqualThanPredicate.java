...
/**
 * The Class BeanPropertyValueComparableGreaterOrEqualThanPredicate.
 */
public class BeanPropertyValueComparableGreaterOrEqualThanPredicate<T> extends AbstractBeanPropertyValuePredicate<T> {
	/**
	 ...
	 */
	public BeanPropertyValueComparableGreaterOrEqualThanPredicate(String propertyName, Object propertyValue) {
