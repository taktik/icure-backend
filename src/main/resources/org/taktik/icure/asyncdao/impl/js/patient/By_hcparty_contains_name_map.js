map = function(doc) {
  ...
  if (doc.java_type == 'org.taktik.icure.entities.Patient' && !doc.deleted) {
    ...
    if (doc.lastName || doc.firstName) {
      if (doc.delegations) {
        Object.keys(doc.delegations).forEach(function (k) {
          emit_normalized_substrings(k, (doc.lastName ? doc.lastName : "") + (doc.firstName ? doc.firstName : ""), doc._id, latin_map);
        });
      }
    }
    if (doc.maidenName && doc.maidenName != doc.lastName) {
      if (doc.delegations) {
        Object.keys(doc.delegations).forEach(function (k) {
          emit_normalized_substrings(k, doc.maidenName, doc._id, latin_map);
        });
      }
    }
    if (doc.spouseName && doc.spouseName != doc.lastName) {
      if (doc.delegations) {
        Object.keys(doc.delegations).forEach(function (k) {
          emit_normalized_substrings(k, doc.spouseName, doc._id, latin_map);
        });
      }
    }
  }
