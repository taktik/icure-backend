...
<%@ page import="org.taktik.icure.services.external.http.ReportServlet" %><%@ page import="org.taktik.icure.entities.*"%><%@ page import="org.taktik.icure.entities.embed.*"%><%@ page import="java.util.stream.Collectors"%><%@ page import="java.util.*"%><%@ page import="org.taktik.icure.entities.base.Code"%><%@ page import="org.taktik.icure.be.matrix.Codeline"%><%@ page import="java.time.format.DateTimeFormatter"%><%@ page import="java.time.format.DateTimeFormatter"%><%@ page import="java.util.Locale"%><%@ page import="java.time.ZoneId"%>
<%
  ...
  DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-yy").withLocale( Locale.FRANCE ).withZone( ZoneId.systemDefault() );
   for (int i=0;i<10;i++) {
    	cls.add(new Codeline(i<invoice.getInvoicingCodes().size()?invoice.getInvoicingCodes().get(i):null, i+10<invoice.getInvoicingCodes().size()?invoice.getInvoicingCodes().get(i+10):null, formatter));
    }
