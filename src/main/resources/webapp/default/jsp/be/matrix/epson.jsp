...
<%@ page import="org.taktik.icure.services.external.http.ReportServlet" %><%@ page import="org.taktik.icure.entities.*"%><%@ page import="org.taktik.icure.entities.embed.*"%><%@ page import="java.util.stream.Collectors"%><%@ page import="java.util.*"%><%@ page import="org.taktik.icure.entities.base.Code"%><%@ page import="org.taktik.icure.be.matrix.Codeline"%><%@ page import="java.time.format.DateTimeFormatter"%><%@ page import="org.taktik.icure.logic.impl.PatientLogicImpl"%><%@ page import="org.slf4j.Logger"%><%@ page import="org.slf4j.LoggerFactory"%>
<%
...
</c:forEach>                  Dr. ${hcp.firstName!=null?hcp.firstName:"N/A"} ${hcp.lastName!=null?hcp.lastName:"N/A"}
