...
internal class FormTemplateLayoutTest {
    ...
    fun map() {
        ...
        val layout = objectMapper.writeValueAsBytes(FormTemplateLayout(
                form = "My form",
        ...
        val result = FormTemplateMapperImpl(DocumentGroupMapperImpl(), CodeStubMapperImpl()).map(FormTemplate(
                id = "123",
                layout = layout
        ))
