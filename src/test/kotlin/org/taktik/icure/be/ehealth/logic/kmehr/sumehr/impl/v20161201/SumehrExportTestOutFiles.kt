...
private fun generateMinimalist() {
    ...
    val stream = File("src/test/resources/org/taktik/icure/be/ehealth/logic/kmehr/sumehr/impl/v20161201/outMinimalistSumehr.xml").outputStream()
    ...
    val secretForeignKeys = listOf("sfks")
    ...
    sumehrExport.createSumehr(stream, patient, secretForeignKeys, sender, recipient, language, comment, excludedIds, decryptor)
}
